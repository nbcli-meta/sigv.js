...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 240.0, 50.0, 23.0 ],
					"text" : "logic 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 154.0, 208.0, 52.0, 23.0 ],
					"text" : "sel done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 55.0, 174.0, 118.0, 23.0 ],
					"text" : "patcherargs @logic 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 127.0, 50.0, 37.0 ],
					"text" : "paramctrl 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 154.0, 91.0, 52.0, 23.0 ],
					"text" : "sel done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.0, 58.0, 146.0, 23.0 ],
					"text" : "patcherargs @paramctrl 0."
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 196.5, 239.0, 36.5, 239.0 ],
					"order" : 1,
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 196.5, 121.5, 36.5, 121.5 ],
					"order" : 1,
					"source" : [ "obj-9", 1 ]
				}
