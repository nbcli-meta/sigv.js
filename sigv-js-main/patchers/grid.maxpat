...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 233.0, 55.0, 23.0 ],
					"text" : "xfade $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 129.0, 277.0, 211.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 172.0, 417.0, 168.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 64.0, 391.0, 53.0, 23.0 ],
					"text" : "route op"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 117.0, 457.0, 111.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 279.0, 194.0, 61.0, 23.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 216.0, 500.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 149.0, 368.0, 191.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 27.600000000000023, 559.0, 312.399999999999977, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 117.0, 417.0, 51.0, 23.0 ],
					"text" : "jit.xfade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 27.600000000000023, 90.0, 241.0, 23.0 ],
					"text" : "route anim triple reset iso material gs1 gs2 ^"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.600000000000023, 277.0, 76.0, 23.0 ],
					"text" : "jit.anim.drive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.600000000000023, 525.0, 153.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 117.0, 316.0, 223.0, 37.0 ],
					"text" : "jit.gl.gridshape @poly_mode 1 1 @shape plane @matrixoutput 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 37.100000000000023, 456.5, 37.100000000000023, 456.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-57", 0 ],
					"midpoints" : [ 288.5, 297.5, 126.5, 297.5 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 126.5, 502.0, 37.100000000000023, 502.0 ],
					"order" : 1,
					"source" : [ "obj-61", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 126.5, 487.5, 225.5, 487.5 ],
					"order" : 0,
					"source" : [ "obj-61", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 225.5, 554.0, 110.450000000000017, 554.0 ],
					"source" : [ "obj-68", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-57", 0 ],
					"midpoints" : [ 107.5, 415.0, 126.5, 415.0 ],
					"source" : [ "obj-78", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-61", 0 ],
					"midpoints" : [ 73.5, 433.0, 126.5, 433.0 ],
					"source" : [ "obj-78", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 175.850000000000023, 233.0, 126.5, 233.0 ],
					"source" : [ "obj-9", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 231.350000000000023, 153.0, 288.5, 153.0 ],
					"source" : [ "obj-9", 7 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 259.100000000000023, 308.5, 37.100000000000023, 308.5 ],
					"source" : [ "obj-9", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 203.600000000000023, 250.0, 158.5, 250.0 ],
					"source" : [ "obj-9", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 148.100000000000023, 162.5, 181.5, 162.5 ],
					"source" : [ "obj-9", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 181.5, 506.0, 37.100000000000023, 506.0 ],
					"source" : [ "obj-98", 0 ]
				}
