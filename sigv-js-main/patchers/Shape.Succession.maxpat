...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 71.0, 152.0, 150.0 ],
					"text" : "A process that simulates morphogenesis in forming energy, and operates on a cybernetic view of feedback systems.  A fluctuation flow of integration and differentiation between both climatic and existing factors."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 36.0, 132.0, 23.0 ],
