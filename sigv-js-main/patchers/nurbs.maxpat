...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 192.600000000000023, 423.0, 56.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.600000000000023, 448.0, 98.0, 23.0 ],
					"text" : "shader surfshade"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 195.100000000000023, 167.0, 136.0, 37.0 ],
					"text" : "jit.gl.shader @name surfshade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 373.0, 88.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 129.0, 307.0, 211.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.600000000000023, 59.0, 69.0, 23.0 ],
					"text" : "route nurbs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 27.600000000000023, 505.0, 263.0, 52.0 ],
					"text" : "jit.gl.nurbs monde @enable 0 @depth_enable 1 @blend_enable 1 @lighting_enable 1 @animmode local"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 27.600000000000023, 90.0, 205.0, 23.0 ],
					"text" : "route anim triple reset iso handle surf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.600000000000023, 398.0, 153.0, 23.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 80.5, 461.5, 37.100000000000023, 461.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 55.100000000000023, 494.0, 37.100000000000023, 494.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 138.5, 439.5, 37.100000000000023, 439.5 ],
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 99.100000000000023, 306.0, 80.5, 306.0 ],
					"source" : [ "obj-9", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 130.100000000000023, 314.5, 55.100000000000023, 314.5 ],
					"source" : [ "obj-9", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 161.100000000000023, 290.5, 138.5, 290.5 ],
					"source" : [ "obj-9", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 223.100000000000023, 377.0, 37.100000000000023, 377.0 ],
					"source" : [ "obj-9", 6 ]
				}
