...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 73.0, 152.0, 122.0 ],
					"text" : "A process that simulates the receiving of sensor data at various layers of the sensorium.  The receptor types differentiate themselves within the contexts of  quality, density, and (CFD?)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 36.0, 142.0, 23.0 ],
