...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 97.0, 172.0, 78.0, 23.0 ],
					"text" : "route texture"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 229.0, 222.0, 23.0 ],
					"text" : "jit.gl.texture @name tex0 @adapt 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 23.0, 40.0, 59.0, 23.0 ],
					"text" : "route fpic"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 13.0, 41.0, 23.0 ],
					"text" : "r coda"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 84.5, 152.0, 76.0 ],
					"pic" : "IMG_7280 2.jpg"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "IMG_7280 2.jpg",
				"bootpath" : "~/_studio/material/water plant",
				"patcherrelativepath" : "../../../_studio/material/water plant",
				"type" : "JPEG",
				"implicit" : 1
			}
 ],
