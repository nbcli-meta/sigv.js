...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 207.5, 27.0, 85.0, 23.0 ],
					"text" : "receive~ audio"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 207.5, 81.0, 100.0, 5.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 162.0, 64.0, 100.0, 5.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 207.5, 92.0, 100.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 162.0, 75.0, 100.0, 21.0 ],
					"text" : "SIGV-JS",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 201.5, 97.0, 23.0 ],
									"text" : "route bang"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 112.5, 115.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 171.5, 97.0, 23.0 ],
									"text" : "route text"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 137.5, 233.5, 325.75, 233.5, 325.75, 101.5, 59.5, 101.5 ],
									"order" : 1,
									"source" : [ "obj-18", 1 ]
								}
...
,
					"patching_rect" : [ 12.5, 51.0, 45.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 59.5, 51.0, 248.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 21.0, 248.0, 24.0 ],
					"tabmode" : 0,
					"varname" : "cmdr"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 356.0, 124.0, 45.0, 23.0 ],
					"text" : "s coda"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 99.0, 20.0, 23.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 7.0, 41.0, 23.0 ],
					"text" : "r coda"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 334.0, 36.0, 48.0, 23.0 ],
					"text" : "route js"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.086274509803922, 0.266666666666667, 0.345098039215686, 1.0 ],
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 66.0, 51.0, 23.0 ],
					"saved_object_attributes" : 					{
						"filename" : "sigv.js",
						"parameter_enable" : 0
					}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "sigv.js",
				"bootpath" : "~/sigv.js/sigv-js-main/code",
