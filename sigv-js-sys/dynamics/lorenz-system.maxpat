...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.899999999999977, 272.0, 76.0, 23.0 ],
					"text" : "s lorenz-data"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 13,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 28.100000000000023, 80.0, 322.0, 23.0 ],
					"text" : "route sample activate mesh anim material ^ a b c dt val data"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.899999999999977, 241.0, 430.450000000000045, 23.0 ],
					"text" : "lorenz"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "lorenz.maxpat",
				"bootpath" : "~/Desktop/systems/attractors",
				"patcherrelativepath" : "../../attractors",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
